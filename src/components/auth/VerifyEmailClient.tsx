      ...
      <div className="w-full max-w-md">
          ...
          <>
            ...
            <div className="mt-8 space-y-4">
              <div className="flex items-center p-4 bg-cyan-50 rounded-xl">
                ...
                <p className="text-sm text-cyan-700">Verification token received</p>
              </div>
            </div>
            ...
            <div className="mt-8 p-6 bg-gray-50 border border-gray-100 rounded-2xl">
              ...
              <p className="text-gray-600 text-sm">
                ...
                <Link href="/sign-in" className="text-cyan-600 hover:text-cyan-500 mx-1">
                  signing in again
                </Link>
        ...
        {status === 'success' && (
          <div className="text-center">
            <div className="w-20 h-20 mx-auto mb-8 bg-cyan-100 rounded-full flex items-center justify-center">
